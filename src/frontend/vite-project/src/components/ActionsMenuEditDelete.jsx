...
export function ActionsMenuEditDelete({ element_type, element_id, setSuccessMessage, setErrorMessage }) {
    ...
    const handleDeleteSubcategory = async () => {
        // TODO mostrar una lista con las subcategorías para poder borrar
        try {
            await axios.delete(`http://localhost:8000/subcategories/${element_id}`);
