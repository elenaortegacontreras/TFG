...
export function SavingGoalCard({ id, name, description, current_amount_saved, target_amount, insert_date, target_date, currency }) {
    ...
    return (
        ...
        <div onClick={handleSavingGoalClick} className="btn card bg-base-100 w-auto h-auto min-h-[300px] min-w-[150px] shadow-xl">
            ...
            <div className="card-body flex flex-col justify-center items-center">
                <h2 className="card-title flex justify-center items-center">
                    <div className="flex items-center space-x-2">
                        ...
                        <p className="text-center">{truncateText(name || "Sin descripción", 12)}</p>
                    </div>
                </h2>
                <p id="description" className="text-center">{truncateText(description || "Sin descripción", 15)}</p>
