...
export function SavingGoalCard({ name, description, current_amount_saved, target_amount, insert_date, target_date, currency }) {
    const navigate = useNavigate();
    const percentage = (current_amount_saved / target_amount) * 100;

    const handleSavingGoalClick = () => {
        navigate('/savings', { state: { name, description, current_amount_saved, target_amount, insert_date, target_date, currency } });
    };
