    ...
    return (
        <div>
            <div className="px-2 flex items-center justify-between">
                ...
                <div className="flex items-center justify-between self-end space-x-4 ml-auto">
                    <div> <p className="px-4">{formattedDate}</p></div>
                    ...
                    <ActionsMenuEditDelete element_type={transaction_type} element_id={transaction_id}/>
