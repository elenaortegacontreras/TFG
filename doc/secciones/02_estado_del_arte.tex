...
\begin{itemize}
    ...
    \begin{figure}[ht!]
        ...
        \begin{minipage}{0.45\textwidth}
            ...
            \caption{Captura de pantalla de la hucha de ahorro en ImaginBank.}
        ...
        \begin{minipage}{0.45\textwidth}
            ...
            \caption{Captura de pantalla del mapa de compras en Banco Santander.}
            \label{fig:mapa_compras_santander}
        \end{minipage}
    \end{figure}

    \item \textbf{BBVA}\cite{bbva_salud_financiera}\\
...
Además, existen aplicaciones de gestión avanzada como \textbf{Pleo}\cite{gastos-pleo}, que ofrece una solución para la gestión 
